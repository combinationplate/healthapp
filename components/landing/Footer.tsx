        ...
        <div className="mb-10 grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            ...
            <ul className="list-none">
              ...
              <li className="mb-2"><Link href="/free-ce-for-therapists" className="text-[14px] text-white/65 hover:text-white">CE for Therapists (PT/OT/SLP)</Link></li>
              ...
              <li className="mb-2"><Link href="/free-ce/social-work" className="text-[14px] text-white/65 hover:text-white">Social Work CE Requirements by State</Link></li>
