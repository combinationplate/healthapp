...
export function RoleSelector({ onSelect }: Props) {
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-[var(--cream)] bg-[radial-gradient(ellipse_60%_50%_at_20%_20%,var(--blue-glow),transparent),radial-gradient(ellipse_50%_40%_at_80%_70%,var(--teal-glow),transparent)]">
      <div className="w-full max-w-[460px] rounded-[var(--r-xl)] border border-[var(--border)] bg-white p-11 shadow-[var(--shadow-lg)]">
        ...
        <div className="grid gap-2 mb-5">
          <button
            ...
            className="rounded-[var(--r-lg)] border-2 border-transparent bg-[var(--cream)] px-4 py-3.5 text-left transition-colors hover:bg-[var(--sage)] focus:bg-[var(--blue-glow)] focus:border-[var(--blue)]"
          >
